...
namespace CuaHangLLPro
{
    public partial class uCrtThongKe : UserControl
    {
        ...
        private void createColumnChiTietHD(ListView lvw)
        {
            ...
            lvw.Columns.Add("Tên sách", 210);
            lvw.Columns.Add("Gía sách", 70);
            lvw.Columns.Add("Số lượng", 60);          
            lvw.Columns.Add("Tổng tiền", 100);
            lvw.Columns.Add("Giảm giá(%)", 80);
            lvw.Columns.Add("Thành tiền", 100);
            lvw.Columns.Add("Nhân viên", 100);
            lvw.Columns.Add("Khách hàng", 100);
        ...
        private void createColumnChiTietSach(ListView lvw)
        {
            ...
            lvw.Columns.Add("Gía sách", 150);
            lvw.Columns.Add("Số lượng đã bán", 160);
            lvw.Columns.Add("Doanh thu", 100);
            lvw.View = View.Details;
            lvw.GridLines = true;
            lvw.FullRowSelect = true;
        }
        ...
        {
            using(SaveFileDialog sdf = new SaveFileDialog() { Filter = "Excel worlkbook| *.xls", ValidateNames = true } )
            {

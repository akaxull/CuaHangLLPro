...
namespace CuaHangLLPro
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="QLCuaHang1")]
    ...
    partial void DeletetblTaiKhoan(tblTaiKhoan instance);
		...
		public CuaHangLLProDataContext() : 
				base(global::CuaHangLLPro.Properties.Settings.Default.QLCuaHang1ConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnMatKhauChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tblNhanVien_tblTaiKhoan", Storage="_tblNhanVien", ThisKey="MaNhanVien", OtherKey="MaNhanVien", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public tblNhanVien tblNhanVien
		{
			get
			{

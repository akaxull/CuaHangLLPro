...
namespace CuaHangLLPro
{
    class clsSach : clsKetNoi
    {
        ...
        {
            IEnumerable<tblSach> a = GetAllSach();
            int demsach = 0;
        ...
        public string getMaSach(string ten, int soLuongSach)
        {
            int count = 0;
            ...
            return (name + soLuongSach.ToString());
        }
        ...
        public IEnumerable<tblSach> getSachHetHang(IEnumerable<tblSach> dsSach)
        {
            IEnumerable<tblSach> s = from sach in dsSach.Where(q => q.SoLuong  == 0)
                                     select sach;
            return s;
        }
        public IEnumerable<tblSach> getSachConHang(IEnumerable<tblSach> dsSach)
        {
            IEnumerable<tblSach> s = from sach in dsSach.Where(q => q.SoLuong > 0)
                                     select sach;
            return s;
        }
        public IEnumerable<tblSach> getSachNgungKinhDoanh(IEnumerable<tblSach> dsSach)
        {
            IEnumerable<tblSach> s = from sach in dsSach.Where(q => q.TrangThai == false)
                                     select sach;
            return s;
        }

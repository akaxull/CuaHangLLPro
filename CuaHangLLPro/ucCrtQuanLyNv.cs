...
{
    public partial class ucCrtQuanLyNv : UserControl
    {
        public ucCrtQuanLyNv()
        {
            InitializeComponent();
        }
        clsNhanVien nv;
        clsTaiKhoan tk;
        private void ucCrtQuanLyNv_Load(object sender, EventArgs e)
        {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Họ Và Tên Nhập Không Dấu,Viết hoa chữ cái đầu", "Thông Báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtTen.Focus();
                return;
            }
